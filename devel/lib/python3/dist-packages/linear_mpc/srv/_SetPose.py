...
"""autogenerated by genpy from linear_mpc/SetPoseRequest.msg. Do not edit."""
import sys
...
class SetPoseRequest(genpy.Message):
  ...
  _type = "linear_mpc/SetPoseRequest"
...
def _get_struct_7d():
    ...
    return _struct_7d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from linear_mpc/SetPoseResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class SetPoseResponse(genpy.Message):
  ...
  _type = "linear_mpc/SetPoseResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """"""
  __slots__ = []
  _slot_types = []
