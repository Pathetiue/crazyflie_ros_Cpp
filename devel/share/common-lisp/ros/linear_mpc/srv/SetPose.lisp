...
(cl:defmethod cl:initialize-instance :after ((m <SetPose-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPose-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name linear_mpc-srv:<SetPose-request> is deprecated: use linear_mpc-srv:SetPose-request instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <SetPose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader linear_mpc-srv:pose-val is deprecated.  Use linear_mpc-srv:pose instead.")
  (pose m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetPose-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPose-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name linear_mpc-srv:<SetPose-response> is deprecated: use linear_mpc-srv:SetPose-response instead.")))
